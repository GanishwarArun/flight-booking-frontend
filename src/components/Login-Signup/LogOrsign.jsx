    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100 py-12">
      <section className="bg-white shadow-xl rounded-lg overflow-hidden flex w-full max-w-4xl">
        ...
        <div className="w-1/2 bg-purple-700 p-8 flex flex-col items-center justify-center text-white">
          ...
          <p className="mb-8 text-white">You chose the right option</p>
          <ul className="flex space-x-4">
            ...
            <li>
              <a
                href="/#"
                className="p-2 bg-blue-400 rounded-full hover:bg-blue-300 transition"
              >
        ...
        <div className="w-1/2 bg-white p-8 flex flex-col justify-center">
          ...
          <form onSubmit={submitData} className="space-y-4">
            ...
            <div className="relative">
              ...
              />
              <label className="absolute left-4 top-3 text-gray-500 pointer-events-none transition-all transform -translate-y-1/2 text-sm font-bold">
                Email-Id
              </label>
            </div>
            <div className="relative">
